...
if [ "$current_user" == "steve-calla" ]; then
    JS_FILE="/home/steve-calla/development/usat/sql_programs/utilities/cron_get_all_member_sales_updated_at/script.js"
    NODE_PATH="/home/$current_user/.nvm/versions/node/v18.20.4/bin/node"
elif [ "$current_user" == "usat-server" ]; then
    JS_FILE="/home/usat-server/development/usat/sql_programs/utilities/cron_get_all_member_sales_updated_at/script.js"
    NODE_PATH="/usr/bin/node"
elif [ "$current_user" == "calla" ]; then
    JS_FILE="C:/Users/calla/development/usat/sql_programs/utilities/cron_get_all_member_sales_updated_at/script.js"
