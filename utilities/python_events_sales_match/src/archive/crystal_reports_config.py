...
INPUT_FILE = "src/event_input_crystal_reports/sanctioning_list_042325_fixed_dates.xlsx"

PATH_PREFIX_OUTPUT = "src/event_output_crystal_reports/"
OUTPUT_FILE = f"{PATH_PREFIX_OUTPUT}cleaned_grouped_event_data_with_summary.xlsx"
os.makedirs("src/event_output_crystal_reports", exist_ok=True)
