...
echo "Running race_results_transform slack_race_results_transform cron job."

# PATH TO JS FILE
if [ "$current_user" == "steve-calla" ]; then
    # mac
    utilities/cron_get_slack_events_data
    JS_FILE="/home/steve-calla/development/usat/sql_programs/utilities/cron_get_slack_race_results_transform/script.js"
    NODE_PATH="/home/$current_user/.nvm/versions/node/v18.20.4/bin/node"
elif [ "$current_user" == "usat-server" ]; then
    # linux
    JS_FILE="/home/usat-server/development/usat/sql_programs/utilities/cron_get_slack_race_results_transform/script.js"
    NODE_PATH="/usr/bin/node"
elif [ "$current_user" == "calla" ]; then
    # windows
        # C:\Users\calla\development\usat\sql_programs\utilities\cron_get_slack_race_results_transform\script.js
    JS_FILE="C:/Users/calla/development/usat/sql_programs/utilities/cron_get_slack_race_results_transform/script.js"
