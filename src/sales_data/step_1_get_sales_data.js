    ...
    try {
        ...
        const date_periods = [
            ...
            { 
                ...
                end_date: '2026-01-01', // set to the next day because the comparison is based on the time stamp not the date
            },
            { 
                year: 2026,
                membership_period_ends: '2008-01-01',
                start_date: '2026-01-01',
                end_date: '2026-07-01', // set to the next day because the comparison is based on the time stamp not the date
            },
            { 
                year: 2026,
                membership_period_ends: '2008-01-01',
                start_date: '2026-07-01',
                end_date: '2027-01-01', // set to the next day because the comparison is based on the time stamp not the date
            },
        ];
