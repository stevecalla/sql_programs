...
// One row per (year, month, home_state, event_state, is_ironman); month is NULL for the annual roll-up.
const participation_flows_schema = [
  ...
  { "name": "is_ironman", "mode": "NULLABLE", "type": "INTEGER", "description": "Destination-event IRONMAN flag for this flow (1 = IRONMAN, 0 = non-IRONMAN)", "fields": [] },
