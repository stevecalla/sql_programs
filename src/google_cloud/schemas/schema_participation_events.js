...
const participation_events_schema = [
  ...
  { "name": "away", "mode": "NULLABLE", "type": "INTEGER", "description": "Participations from out-of-state athletes (member state is one of the 50, <> event state)", "fields": [] },
  { "name": "unknown_home_count", "mode": "NULLABLE", "type": "INTEGER", "description": "Participations whose home state is missing or not one of the 50 states; home + away + unknown = turnout", "fields": [] },
  { "name": "unknown_home_pct", "mode": "NULLABLE", "type": "INTEGER", "description": "unknown_home_count / turnout, percent", "fields": [] },
