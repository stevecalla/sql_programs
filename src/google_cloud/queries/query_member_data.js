const query_member_data = `
    SELECT 
        ...
        DATE_FORMAT(starts_events, '%Y-%m-%d') AS starts_events, -- date '2024-02-12'

        starts_month_events,
        starts_quarter_events,
        starts_year_events,   
        
        DATE_FORMAT(ends_events, '%Y-%m-%d') AS ends_events, -- date '2024-02-12'
    ...
    WHERE purchased_on_year_adjusted_mp > 2021
    -- LIMIT 10;
`;
