...
const { query_alter_drop_deleted_profiles } = require('../queries/sales_data/7_1c_alter_drop_deleted_profiles');
...
async function execute_alter_drop_deleted_profiles() {
  ...
  try {
    ...
    const sql_alter_table = query_alter_drop_deleted_profiles;
...
//   execute_alter_drop_deleted_profiles()
//   .catch(err => {
