...
async function main() {
    ...
    const options = [
        {
            fileName: 'runsignup_data_raw_affiliate_urls',
            query: (retrieval_batch_size, offset) => query_runsignup_affiliate_data(retrieval_batch_size, offset, 'all_runsignup_data_raw_affiliate_urls'),
            tableId: 'runsignup_data_raw_affiliate_urls', // table name

            // fileName: 'runsignup_data_raw_affiliate_urls_v2',
            // tableId: "runsignup_data_raw_affiliate_urls_v2",
        }
    ];
...
module.exports = {
    execute_load_big_query_runsignup_affliate_url: main,
}
