...
async function step_4_create_participation_with_membership_match(start_date_time, end_date_time) {
    return `
        SET @start_date = '2025-01-01';
        SET @end_date = '2025-03-16';

        INSERT INTO all_participation_data_with_membership_match
            WITH participation AS (
                SELECT *
                FROM all_participation_data_raw
                -- FROM all_participation_data_with_regions
                WHERE 1 = 1 
