...
function step_1_sales_year_over_year_data() {
    ...
    CREATE TABLE sales_data_year_over_year AS
        WITH all_data AS (
            ...
            WHERE 
                purchased_on_year_adjusted_mp = @current_year -- get this year
                AND purchased_on_date_adjusted_mp <= @current_year_date_yesterday -- get all dates excluding today to ensure full day
            ...
            FROM usat_sales_db.sales_key_stats_2015
            WHERE 
                purchased_on_year_adjusted_mp = @prior_year -- get prior
                AND purchased_on_date_adjusted_mp <= @prior_year_date_yesterday -- get all dates excluding today to ensure full day
