...
function step_5a_member_age_at_end_of_year_of_sale_query(FROM_STATEMENT, WHERE_STATEMENT = '', ORDER_BY_STATEMENT = '') {
    return `
        -- STEP #5a = CREATE TABLE step_5a_member_age_at_end_of_year_of_sale AS
        WITH sale_years AS (
            SELECT
                am.id_membership_periods_sa,
...
module.exports = {
    ...
    step_5a_member_age_at_end_of_year_of_sale_query,
}
