...
function step_5_member_age_at_sale_date_query(FROM_STATEMENT, WHERE_STATEMENT = '', ORDER_BY_STATEMENT = '') {
    return `
        -- STEP #5 = CREATE TABLE step_5_member_age_at_sale_date AS
        WITH min_dates AS (
            SELECT
                am.id_membership_periods_sa,
...
module.exports = {
    ...
    step_5_member_age_at_sale_date_query,
}