...
const { step_7a_event_name_clean } = require('./step_7a_event_name_clean');
...
async function query_step_0_sales_key_metrics_master_logic() {
    const query_list = [
        ...
        step_7a_event_name_clean, // #9 very fast, 5722 results
        step_8_sales_key_stats_2015, // #10 Timer: 00:18:03...Query results: 3649353
        step_8a_create_indexes, //#11  Timer: 00:16:35...Query results: 0
    ]
    return query_list;
}
