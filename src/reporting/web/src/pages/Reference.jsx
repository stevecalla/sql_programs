...
const REF = [
  ...
  { title: 'Penetration & Opportunity (per-capita)', note: 'Per-capita metrics use US Census population loaded by step 2c. The exact population source + vintage appears in the population/penetration metric tooltips.', items: [
    ...
    ['Opportunity view — bands', 'Four bands — Leader / Mid / Under-penetrated / Floor — set three ways on the active basis. National-relative (default): Leader ≥ the national rate, Floor ≤ half national (Mid empty). Statistical: from the distribution of state penetration values — Quantile (Leader = top 20%, Floor = bottom 20%, split at the median) or Std-dev (Leader ≥ mean+σ, Floor ≤ mean−σ, split at the mean; σ multiplier adjustable). Absolute: fixed cutoffs you type.'],
