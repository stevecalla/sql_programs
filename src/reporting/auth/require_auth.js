'use strict';
// Express middleware gating routes by the signed session cookie. Copied from the merge tool's
// require_auth. require_auth = any valid session; require_admin = role 'admin'; require_panel = the
// panel allow-list.
