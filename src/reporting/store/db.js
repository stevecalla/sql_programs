'use strict';
// Read-only MySQL access for the reporting app. Reuses the repo's shared local DB config
// (utilities/config -> local_usat_sales_db_config) so it points at the same usat_sales_db the
// rest of the pipeline uses. One lazily-created pool. Copied from src/salesforce_merge/store/db.js.
