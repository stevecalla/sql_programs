'use strict';
// User management CLI for the reporting app (mirrors src/salesforce_merge/admin.js). Usage:
...
// Stored users live OUTSIDE the repo (auth.json); .env recovery accounts (REPORTING_ADMIN_*,
// REPORTING_TEST_*) are managed in the repo-root .env, not here.
