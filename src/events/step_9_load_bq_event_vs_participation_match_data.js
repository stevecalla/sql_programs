...
const { query_event_vs_participation_match_data } = require('../google_cloud/queries/query_event_vs_participation_match_data');
const { event_vs_participation_match_schema } = require('../google_cloud/schemas/schema_event_vs_participation_match_data');

const { execute_load_data_to_bigquery } = require('../google_cloud/step_0_load_main_job');

// EXECUTE LOAD BIQ QUERY
async function execute_load_bq_event_vs_participation_match_data() {
    ...
    const options = [
        {
            fileName: 'event_vs_participation_match_data',
            query: (retrieval_batch_size, offset) => query_event_vs_participation_match_data(retrieval_batch_size, offset),
            tableId: 'event_vs_participation_match_data', // table name
            
            // fileName: 'event_vs_participation_match_data_v2',
            // tableId: "event_vs_participation_match_data_v2",
        }
    ];
    ...
    const schema = event_vs_participation_match_schema;
...
// execute_load_bq_event_vs_participation_match_data();
// (async () => {
//     try {
//         console.log('\nStarting data load.');
