 ...
 *   1. Internal operator page   — /chatbot/bot   (auth'd; grounds on curated knowledge, never PII)
...
const SECTIONS = [
  ...
  { label: 'OPEN in a browser', color: GREEN, items: [
    ...
    { id: 16, label: 'Open internal operator page', desc: 'The auth\'d chatbot operator surface (/chatbot/bot).', open: `http://localhost:${DEV_PORT}/chatbot/bot`, cli: `open http://localhost:5175/chatbot/bot` },
  ]},
