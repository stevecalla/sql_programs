'use strict';
// Metrics config + events-table DDL contract. Pure (no DB / no network). Ported 1:1 from the standalone
// POC's tests/metrics.test.js; only the DDL require path changes for the platform layout (the DDL lives
// at the repo-level src/queries/, reached via ../../../../queries/ from the module's tests/ dir — the
// same path metrics/events.js uses).
