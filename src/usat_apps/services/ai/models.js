...
// Config reader is injectable (admin Settings wires the real one in a later phase); defaults to none
// so the built-in model/pricing list applies until an override is provided.
let _config_reader = function () { return {}; };
function set_config_reader(fn) { if (typeof fn === 'function') _config_reader = fn; }
...
module.exports = { list, default_model, default_for, price_for, cost_for, DEFAULT_PRICES, builtin, set_config_reader };
