  ...
  if (status === 'idle') {
    return (
      <div className="coi-runrow">
        ...
        <a className="coi-dl" href={PORTAL_FORM_URL} target="_blank" rel="noreferrer" title="Open the live portal form in a new tab (opens blank — filling happens on the server)">Portal form ↗</a>
        {err
  ...
  return (
    <div className="coi-run">
      <div className="coi-run-status">
        ...
        <a className="coi-dl" href={PORTAL_FORM_URL} target="_blank" rel="noreferrer" style={{ marginLeft: 8 }} title="Open the live portal form in a new tab (opens blank)">Portal form ↗</a>
      </div>
