...
export default function Metrics({ user }) {
  ...
  const [showTest, setShowTest] = useState(true);   // default ON — show everything incl. test rows (aligned with the platform Metrics page)
  ...
  return (
    <>
      ...
      <div className="mx-cards">
        ...
        <Card k="Queue removes" v={fmt(d.queue_removes)} s="removed from queue" />
