    ...
    body: (
      <>
        ...
        <div className="defs">
          ...
          <div className="defs-row"><span className="defs-term lg">History page</span><span className="defs-body">the <strong>History</strong> tab is a searchable, sortable, exportable view of that audit — every processed set across merge / restore / recreate / simulate / skip / fail. Filter by result, search by survivor name / account id / source, and expand a row for the field-level diff (drift, or restore/recreate reset + kept).</span></div>
