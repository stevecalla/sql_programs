...
export const api = {
  ...
  evalRuns: (limit, queue) => req(P + '/eval/runs' + qs({ limit, queue })),
  evalRerun: (run_id) => req(P + '/eval/rerun', { method: 'POST', body: JSON.stringify({ run_id }) }),
  evalOverride: (payload) => req(P + '/eval/result/override', { method: 'POST', body: JSON.stringify(payload) }),
  evalStop: (run_id) => req(P + '/eval/stop', { method: 'POST', body: JSON.stringify({ run_id }) }),
  evalSuggestCorrection: (payload) => req(P + '/eval/suggest-correction', { method: 'POST', body: JSON.stringify(payload) }),
