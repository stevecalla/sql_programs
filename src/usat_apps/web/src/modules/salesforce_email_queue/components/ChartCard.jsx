...
// A chart panel that mirrors the metrics dashboard's chart cards: a Chart.js bar (or grouped
// "multibar"/line) with an Expand / PNG / CSV / Table toolbar and a flip-to-table view. Uses the
// global window.Chart (loaded from CDN in index.html), so no bundler dependency. Colors follow the
// app's CSS theme variables. Email-queue-local copy so the module carries no cross-module import.
