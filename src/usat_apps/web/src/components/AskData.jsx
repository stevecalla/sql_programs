  ...
  return (
    <div>
      <div className="mx-ask-box">
        <textarea ref={taRef} className="mx-ask-q" rows={1} value={q} placeholder={sqlMode ? 'Read-only SELECT over usat_apps_events…' : 'Ask about the usage data…  e.g. page views by user last week'}
          disabled={noKey}
