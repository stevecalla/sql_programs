...
const { query_participation_race_profile} = require('../google_cloud/queries/query_participation_race_profile');
const { participation_race_schema } = require('../google_cloud/schemas/schema_participation_race_profile');

const { execute_load_data_to_bigquery } = require('../google_cloud/step_0_load_main_job');

// EXECUTE LOAD BIQ QUERY
async function execute_load_big_query_participation_race_profile_metrics() {
    ...
    const options = [
        {
            ...
            // tableId: "participation_race_profile_data_v2",
        }
    ];
    ...
    const schema = participation_race_schema;
