...
} = require("../queries/participation_data/");
...
async function insert_data(pool, db_name, table_name, test = false) {
    ...
    const period_interval = 6; // options include 1, 3, 6 months
...
async function execute_create_participation_with_membership_match() {   
    ...
    try {
        ...
        const table_name = `all_participation_data_with_membership_match_v2`;
        console.log(db_name);
